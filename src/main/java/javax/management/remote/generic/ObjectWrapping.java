...
public interface ObjectWrapping {
	 ...
	 * @throws IOException if the object cannot be wrapped
	 *                     for some reason.
	 */
	 ...
	 * @throws ClassNotFoundException if the class that the
	 *                                unwrapped object should have is not known to the given class
	 *                                loader.
	 * @throws IOException            if the object cannot be unwrapped
	 *                                for some reason.
	 */
