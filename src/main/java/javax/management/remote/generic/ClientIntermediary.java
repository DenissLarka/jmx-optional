...
class ClientIntermediary {
	...
	public ClientIntermediary(ClientSynchroMessageConnection connection, ObjectWrapping wrap, GenericConnector client, Map env) {
		...
		communicatorAdmin = new GenericClientCommunicatorAdmin(EnvHelp.getConnectionCheckPeriod(env));
	...
	public ObjectInstance createMBean(String className,
		...
		try {
			return (ObjectInstance)
					mBeanServerRequest(MBeanServerRequestMessage.CREATE_MBEAN, new Object[] {className, name}, delegationSubject);
		}
		...
		try {
			return (ObjectInstance)
					mBeanServerRequest(MBeanServerRequestMessage.CREATE_MBEAN_PARAMS,
							new Object[] {className, name, serialization.wrap(params), signature}, delegationSubject);
		}
		catch (ReflectionException e) {
			throw e;
		}
		...
		try {
			return (ObjectInstance)
					mBeanServerRequest(MBeanServerRequestMessage.CREATE_MBEAN_LOADER,
							new Object[] {className, name, loaderName}, delegationSubject);
		}
		catch (ReflectionException e) {
			throw e;
		}
		...
		try {
			...
			return (ObjectInstance)
					mBeanServerRequest(code,
							new Object[] {className, name, loaderName, serialization.wrap(params), signature}, delegationSubject);
		}
		catch (ReflectionException e) {
			throw e;
		}
	...
	public ObjectInstance getObjectInstance(ObjectName name,
		...
		try {
			return (ObjectInstance)
					mBeanServerRequest(MBeanServerRequestMessage.GET_OBJECT_INSTANCE, new Object[] {name}, delegationSubject);
		}
		catch (InstanceNotFoundException e) {
			throw e;
		}
	...
	public Set queryMBeans(ObjectName name,
		...
		try {
			return (Set)
					mBeanServerRequest(
							MBeanServerRequestMessage.QUERY_MBEANS,
							new Object[] {name, serialization.wrap(query)},
							delegationSubject);
		}
		catch (Exception e) {
			throw appropriateException(e);
		...
		try {
			return (Set)
					mBeanServerRequest(MBeanServerRequestMessage.QUERY_NAMES,
							new Object[] {name, serialization.wrap(query)}, delegationSubject);
		}
		catch (Exception e) {
			throw appropriateException(e);
		}
	...
	public boolean isRegistered(ObjectName name, Subject delegationSubject) throws IOException {
		...
		try {
			Boolean is = (Boolean)
					mBeanServerRequest(MBeanServerRequestMessage.IS_REGISTERED, new Object[] {name}, delegationSubject);
	...
	public Integer getMBeanCount(Subject delegationSubject)
		...
		try {
			return (Integer)
					mBeanServerRequest(MBeanServerRequestMessage.GET_MBEAN_COUNT, null, delegationSubject);
		}
		catch (Exception e) {
			throw appropriateException(e);
		}
	...
	public AttributeList getAttributes(ObjectName name,
		...
		try {
			return (AttributeList)
					mBeanServerRequest(MBeanServerRequestMessage.GET_ATTRIBUTES, new Object[] {name, attributes}, delegationSubject);
		}
		catch (InstanceNotFoundException e) {
			throw e;
		}
	...
	public void setAttribute(ObjectName name,
		...
		try {
			mBeanServerRequest(MBeanServerRequestMessage.SET_ATTRIBUTE,
					new Object[] {name, serialization.wrap(attribute)}, delegationSubject);
		}
		catch (InstanceNotFoundException e) {
			throw e;
		}
	...
	public AttributeList setAttributes(ObjectName name,
		...
		try {
			...
			return (AttributeList)
					mBeanServerRequest(MBeanServerRequestMessage.SET_ATTRIBUTES, new Object[] {name, wrappedAttrs}, delegationSubject);
		}
		catch (InstanceNotFoundException e) {
			throw e;
		}
		...
		try {
			return
					mBeanServerRequest(MBeanServerRequestMessage.INVOKE,
							new Object[] {name, operationName, serialization.wrap(params), signature}, delegationSubject);
		}
		catch (InstanceNotFoundException e) {
			throw e;
		}
	...
	public String getDefaultDomain(Subject delegationSubject)
		...
		try {
			...
			return (String) mBeanServerRequest(code, null, delegationSubject);
		}
		catch (Exception e) {
			throw appropriateException(e);
		}
	...
	public String[] getDomains(Subject delegationSubject)
		...
		try {
			return (String[])
					mBeanServerRequest(MBeanServerRequestMessage.GET_DOMAINS, null, delegationSubject);
		}
		catch (Exception e) {
			throw appropriateException(e);
		}
	...
	public MBeanInfo getMBeanInfo(ObjectName name,
		...
		try {
			return (MBeanInfo)
					mBeanServerRequest(MBeanServerRequestMessage.GET_MBEAN_INFO, new Object[] {name}, delegationSubject);
		}
		catch (InstanceNotFoundException e) {
			throw e;
		}
	...
	public boolean isInstanceOf(ObjectName name,
		...
		try {
			Boolean is = (Boolean)
					mBeanServerRequest(MBeanServerRequestMessage.IS_INSTANCE_OF, new Object[] {name, className}, delegationSubject);
			return is.booleanValue();
		}
		catch (InstanceNotFoundException e) {
			throw e;
	...
	public void addNotificationListener(ObjectName name,
		...
		try {
			...
			mBeanServerRequest(code,
					new Object[] {name, listener, serialization.wrap(filter), serialization.wrap(handback)},
					delegationSubject);
		}
		catch (InstanceNotFoundException e) {
			throw e;
	...
	public void removeNotificationListener(ObjectName name,
		...
		try {
			int code = MBeanServerRequestMessage.REMOVE_NOTIFICATION_LISTENER;
			mBeanServerRequest(code, new Object[] {name, ids}, delegationSubject);
		}
		catch (InstanceNotFoundException e) {
			throw e;
		}
	...
	public void removeNotificationListener(ObjectName name,
		...
		try {
			int code = MBeanServerRequestMessage.REMOVE_NOTIFICATION_LISTENER_OBJECTNAME;
			mBeanServerRequest(code, new Object[] {name, listener}, delegationSubject);
		}
		catch (InstanceNotFoundException e) {
			throw e;
		}
	...
	public void removeNotificationListener(ObjectName name,
		...
		try {
			int code = MBeanServerRequestMessage.REMOVE_NOTIFICATION_LISTENER_OBJECTNAME_FILTER_HANDBACK;
			mBeanServerRequest(code,
					new Object[] {name,
							listener,
	...
	//----------------------------------------------
	//
	private class GenericClientCommunicatorAdmin extends ClientCommunicatorAdmin {
		...
		protected void checkConnection() throws IOException {
			try {
				mBeanServerRequest(MBeanServerRequestMessage.GET_DEFAULT_DOMAIN, null, null, false);
			}
