...
public interface ServerAdmin {
	 ...
	 * the connection etc.
	 *
	 * @param mc an <code>MessageConnection</code> object which has
	 *           been established.
	 * @return an <code>MessageConnection</code> object enhansed.
	 * @throws IOException       Any of the usual Input/Output related exceptions during the verification.
	 * @throws SecurityException if the verification failed.
	 */
	...
	/**
	 * Returns an <code>javax.security.auth.Subject</code> object used for a server to authorize any request from the specified connection.
	 *
	 * @param mc the specified connection.
	 */
