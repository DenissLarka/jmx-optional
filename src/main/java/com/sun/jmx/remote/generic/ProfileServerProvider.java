 ...
 * this interface are created by {@link ProfileServerFactory} as part of its
 * {@link ProfileServerFactory#createProfile(String,Map) createProfile}
 * method.</p>
 */
public interface ProfileServerProvider {
     ...
     * produces a different <code>ProfileServer</code> object.</p>
     *
