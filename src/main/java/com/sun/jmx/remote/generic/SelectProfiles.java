...
public interface SelectProfiles {
	 ...
	 *
	 * @param env            the environment map passed in at connection
	 ...
	 *                       in/out parameter.
	 * @param serverProfiles space-separated list of server
	 *                       supported profiles.
	 * @throws Exception if the server supported profiles do not
