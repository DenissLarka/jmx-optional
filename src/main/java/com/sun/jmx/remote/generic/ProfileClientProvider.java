/*
 * @(#)file      ProfileClientProvider.java
...
public interface ProfileClientProvider {
	 ...
	 * @throws NullPointerException if <code>profile</code> or
	 *                              <code>environment</code> is null.
	 */
	public ProfileClient createProfile(String profile, Map environment) throws ProfileProviderException;
}
