...
public interface CheckProfiles {
	 ...
	 * @throws Exception if the negotiated profiles do not fulfil
	 *                   the expectations of the server's defined security policy.
	 */
	public void checkProfiles(Map env, List clientProfiles, Object clientContext, String connectionId) throws Exception;
}
