...
public class ArrayNotificationBuffer implements NotificationBuffer {
	...
	HashMap/*<MBeanServer,ArrayNotificationBuffer>*/ mbsToBuffer = new HashMap(1);
	...
	private class ShareBuffer implements NotificationBuffer {
		...
		fetchNotifications(Set/*<ListenerInfo>*/ listeners, long startSequenceNumber, long timeout, int maxNotifications)
