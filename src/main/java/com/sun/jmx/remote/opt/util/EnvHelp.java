...
public class EnvHelp {
	...
	public static Throwable initCause(Throwable t, Throwable cause) {
		...
		try {
			Method initCause = t.getClass().getMethod("initCause", new Class[] {Throwable.class});
	...
	public static Throwable getCause(Throwable t) {
		...
		try {
			Method getCause = t.getClass().getMethod("getCause", (Class[]) null);
		...
		if (hide != null) {
			...
			synchronized (defaultHiddenStrings) {
				if (defaultHiddenStrings.isEmpty()) {
					parseHiddenAttributes(hide, defaultHiddenStrings, defaultHiddenPrefixes);
				}
	...
	private static void parseHiddenAttributes(String hide, SortedSet hiddenStrings, SortedSet hiddenPrefixes) {
