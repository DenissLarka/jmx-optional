...
public class ClientListenerInfo extends ListenerInfo {
	public ClientListenerInfo(Integer listenerID,
		...
		super(listenerID, name, listener, filter, handback, delegationSubject);
	}
	...
	public boolean sameAs(ObjectName name,
			...
			NotificationFilter filter,
			Object handback) {
		return (getObjectName().equals(name) && getListener() == listener && getNotificationFilter() == filter && getHandback() == handback);
	}
